...
from db import q, q1, safe_float, safe_int, parse_date_params
...
@payments_bp.route("/api/payment-insights")
...
@payments_bp.route("/api/branch-performance/<int:branch_id>/transactions")
...
@payments_bp.route("/api/payment-insights/filters")
...
@payments_bp.route("/api/payment-insights/table")
